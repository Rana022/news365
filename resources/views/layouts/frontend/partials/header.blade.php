                ...
                <ul class="nav navbar-nav">
                    <li class="active"><a href="home-style-one.html" class="category01">HOME</a></li>
                       @foreach ($categories as $category)
                           ...
                           <li><a href="#" class="category08">{{$category->name}}</a></li>
                           @endif

                           @if ($category->childrenCategories->count())
                           <li class="dropdown">
                            <a href="#" class="dropdown-toggle category02" data-toggle="dropdown">
                                {{$category->name}} 
                            ...
                            <ul class="dropdown-menu menu-slide">
                                ...
                                @if ($childCategory->categories->count())
                                    <li class="dropdown-submenu"><a href="#">{{$childCategory->name}}</a>
                                    <ul class="dropdown-menu zoomIn">
                                        @foreach ($childCategory->categories as $superChild)
                                        <li><a href="home-style-one.html">{{$superChild->name}}</a></li>
                                        @endforeach
                                    </ul>
                                </li>
                                @else
                                <li><a href="login%26registration.html">{{$childCategory->name}}</a></li>
                                @endif
                                @endforeach
                            </ul>
                        </li>
